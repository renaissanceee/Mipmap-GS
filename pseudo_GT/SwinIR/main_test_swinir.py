...
def main():
    ...
    parser.add_argument('--save_dir', type=str, default=None, help='input ground-truth test image folder')
    parser.add_argument('--tile', type=int, default=None, help='Tile size, None for no tile during testing (testing as a whole)')
    parser.add_argument('--tile_overlap', type=int, default=32, help='Overlapping of different tiles')
    parser.add_argument('--dataset', type=str, default="blender", help='./test for blender and ./images for colmap')
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(folder, '*')))):
        if os.path.exists(os.path.join(args.folder_lq,os.path.basename(path))):
            # read image
